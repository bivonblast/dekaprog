...
abstract public class ExportHandler {
    ...
    public static final boolean SHOWVALUE = true;
    public static final boolean HIDEVALUE = false;
     ...
     */
    abstract public boolean writeCharacter(DekaederCharacter character, String username, boolean showValue);
